...
const AuthCodeVerification = Loadable(lazy(() => import('views/pages/authentication/CodeVerification3')));
const AuthForgotPassword = Loadable(lazy(() => import('views/pages/authentication/ForgotPassword3')));
const ComingSoon = Loadable(lazy(() => import('views/pages/authentication/ComingSoon')));
