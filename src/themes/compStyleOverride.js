export default function componentStyleOverrides(theme, borderRadius, outlinedFilled) {
    ...
    const bgColor = mode === 'dark' ? theme.palette.dark[800] : theme.palette.grey[100];
    ...
    const commonOverRides = {
        scrollbarWidth: 'thin',
        scrollbarColor: `${mode === 'dark' ? theme.palette.grey[700] : theme.palette.grey[100]} transparent`
    };
    ...
    return {
        ...
        MuiTableContainer: {
            styleOverrides: {
                root: {
                    ...commonOverRides,
                    border: `solid 2px ${theme.palette.mode === 'dark' ? theme.palette.background.paper : theme.palette.grey[100]}`,
                    borderRadius: '10px'
                }
            }
        },
        MuiTableBody: {
            styleOverrides: {
                root: {
                    backgroundColor: theme.palette.mode === 'dark' ? theme.palette.dark[800] : theme.palette.background.default
                }
            }
        }
    };
