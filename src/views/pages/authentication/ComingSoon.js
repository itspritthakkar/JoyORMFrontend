...
import { formatDateWithSuffix } from 'utils/commons/functions';
...
const ComingSoon = () => {
    ...
    const targetDate = new Date(2025, 7, 27, 0, 0, 0); // Month is 0-indexed (7 = August)

    const { seconds, minutes, hours, days } = useTimer({ expiryTimestamp: targetDate });
                    ...
                    <Grid item xs={12}>
                        <PageContentWrapper>
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item xs={12}>
                                    <Typography variant="body1">Your registration is now complete.</Typography>
                                    <Typography variant="body1">
                                        The competition will begin on {formatDateWithSuffix(targetDate)}.
                                    </Typography>
                                </Grid>
                            </Grid>
                        </PageContentWrapper>
                        ...
                        <TimerWrapper>
                            <Grid container spacing={gridSpacing}>
                                <Grid item xs={3}>
                                    ...
                                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>Days</Box>
                                </Grid>
                                <Grid item xs={3}>
                                    <TimeBlock>{hours}</TimeBlock>
                                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>Hours</Box>
                                </Grid>
                                <Grid item xs={3}>
                                ...
                                <Grid item>
                                    <AnimateButton>
                                        <Button variant="contained" size="large" onClick={logout}>
                                            <LogoutTwoToneIcon sx={{ fontSize: '1.3rem', mr: 0.75 }} /> Logout
                                        </Button>
                                    </AnimateButton>
                                </Grid>
                            </Grid>
