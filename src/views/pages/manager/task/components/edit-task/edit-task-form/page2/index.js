...
import { useOtherAttachmentsContext } from 'views/pages/manager/task/contexts/OtherAttachmentsContext';

const Page2 = () => {
    const theme = useTheme();

    const { loadingItems, loadingValues, items, selectedItemsLocal, setSelectedItemsLocal, handleSave } = useOtherAttachmentsContext();
